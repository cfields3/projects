/** 
    @file integer.h
    @author CSC 230
    @author Christopheer Fields (cwfields)
    Header for the Integer subclass of VType. Defines
    the functions for an Integer, including an extra,
    parseInteger. Also includes a val field in the
    Integer typedefed struct.
*/
